...
var CardModel = sequelize.import('../models/card')
...
router.post("/create", function (req, res) {
    ...
    var concept = req.body.card.concept
    var definition = req.body.card.definition
    var example = req.body.card.example
    var images = req.body.card.images
